...
Encore
    ...
    .addEntry('imageArticle', './assets/imageArticle.js')
    .addEntry('filterShop', './assets/filterShop.js')
    ...
    .addEntry('gestionproduit', './assets/gestionproduit.js')
    .addEntry('listgestion', './assets/listgestion.js')
